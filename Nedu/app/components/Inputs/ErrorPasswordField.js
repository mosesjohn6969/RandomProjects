...
import { StyleSheet, TextInput, TouchableWithoutFeedback, View, Text, KeyboardAvoidingView } from 'react-native';

import { MaterialCommunityIcons } from '@expo/vector-icons';
import { Tooltip } from 'react-native-elements/dist/tooltip/Tooltip';

function ErrorPasswordField({ size = 50, borderRadius = 10, backgroundColor = "#F5F9FF", error, marginVertical = 5, icon, ...otherProps }) {
...
export default ErrorPasswordField;
