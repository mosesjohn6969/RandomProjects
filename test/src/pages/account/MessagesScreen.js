...
const initialMessages = [
    {
        id: 1,
        title: 'Chinedu',
        description: 'yo have you seen the report?',
        image: require('../../assets/images/orb.jpg')
    },
    {
        id: 2,
        title: 'Moses',
        description: 'Guy are you coming today?',
        image: require('../../assets/images/clean.jpg')
    },
    {
        id: 3,
        title: 'Technezz Ideas Hub',
        description: 'What is the plan for today. How do we maximize on the ',
