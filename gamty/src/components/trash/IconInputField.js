...
function IconInputField({ icon, size, iconcolor, style, width, borderRadius, color, error, empty, ...otherProps }) {
    return (
        ...
        <View style={{ flexDirection: "column" }}>
            ...
            <View
                ...
                { width: width, height: size, padding: (size / 4), borderRadius: borderRadius, backgroundColor: color, borderColor: error ? "red" : colors.light }]} >
